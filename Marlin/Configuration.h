...
#define STRING_CONFIG_H_AUTHOR "jaclark" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "ToyBox"
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -.25
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 53, 145} // X,Y,Z Axis Extend and Retract angles
